  ...
  <AuthLayout title="Bem-vindo de volta!" subtitle="Faça login na sua conta para continuar">
    <form className="space-y-6">
      ...
      <div>
        ...
        <input type="password" className="w-full h-12 px-4 rounded-lg border border-gray-300 dark:border-gray-700 bg-transparent focus:ring-2 focus:ring-primary/50" placeholder="••••••••" />
      </div>
      <button className="w-full h-12 bg-primary text-white font-bold rounded-lg hover:bg-primary-600 transition-colors">Entrar</button>
